...
java -Xmx1g -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5005 -cp $SCALATRON_DEV_HOME/lib/Scalatron.jar scalatron.main.Main -plugins $SCALATRON_DEV_HOME/bots -webui $SCALATRON_DEV_HOME/server/dummy -users $SCALATRON_DEV_HOME/server/dummy
